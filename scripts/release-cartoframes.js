/**
 * THIS FILE SHOULD BE DELETED WHEN WE'RE DONE WITH CARTOFRAMES.
 * 
 * It's just a modified version of release-s3 that hardcodes the version
 * to 'cartoframes'. Having to have two different scripts puts makes it
 * clear that the script could use some refactoring but ain't nobody got
 * time fo' that.
 */
