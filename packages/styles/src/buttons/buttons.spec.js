...
// icons
const BUTTON_ICONS_REFERENCE = path.resolve(__dirname, 'test/img/button-icons-reference.png');
const BUTTON_ICONS_SCREENSHOT = path.resolve(__dirname, 'test/img/button-icons-out.png');
const BUTTON_ICONS_URL = `file://${path.resolve(__dirname, 'test/button-icons.html')}`;
...
module.exports = [
  ...
  { reference: BUTTON_ICONS_REFERENCE, screenshot: BUTTON_ICONS_SCREENSHOT, url: BUTTON_ICONS_URL },
];
