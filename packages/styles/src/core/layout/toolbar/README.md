...
On mobile devices, the toolbar is always placed on top, but its position can be modified on desktop by using `left` or `right` modifiers in `as-app` styles.
  - `as-app--nav-left`: Push the toolbar to the left of the viewport. Add it to the `as-app` element.
  - `as-app--nav-right`: Push the toolbar to the right of the viewport. Add it to the `as-app` element.
...
- If the toolbar element has one child, it will be at the start.
...
With that in mind, if you need to layout the items in different positions you can group them using the class
`as-toolbar__group`

In the code example below you can see it in action. `as-toolbar__group` is used to group the logo and some action to the left. (click on the <> to see the code)
...
<header class="as-toolbar">
  <div class="as-toolbar__group">
    ...
    <li class="as-toolbar__item">
      <i class="as-icon-home as-subheader as-m--0"></i>
      <p class="as-toolbar__icon-text">Home</p>
    </li>
    <li class="as-toolbar__item">
      <i class="as-icon-magnify as-subheader as-m--0"></i>
      <p class="as-toolbar__icon-text">Search</p>
...
Now, the same example with the action items in the middle.
...
When seeing it in mobile, these actions are grouped in a hamburger menu. You will needing a button to show the menu.
