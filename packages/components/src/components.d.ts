...
import { DropdownOption, } from "./components/as-dropdown/types/DropdownOption";
import { AxisOptions, HistogramColorRange, HistogramData, HistogramSelection, TooltipFormat, } from "./components/as-histogram-widget/interfaces";
import { RenderOptions, } from "./components/as-histogram-widget/types/RenderOptions";
import { RawStackedbarData, } from "./components/as-stacked-bar-widget/types/RawStackedbarData";
import { Metadata, } from "./components/as-stacked-bar-widget/types/Metadata";
import { RectangleData, } from "./components/as-stacked-bar-widget/types/RectangleData";
import { TimeSeriesData, } from "./components/as-time-series-widget/interfaces";
import { TimeLocaleDefinition, } from "d3-time-format";
import { WidgetLegendData, } from "./components/common/as-widget-legend/types/WidgetLegendData";
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            "as-animation-controls-widget": LocalJSX.AsAnimationControlsWidget & JSXBase.HTMLAttributes<HTMLAsAnimationControlsWidgetElement>;
            "as-category-widget": LocalJSX.AsCategoryWidget & JSXBase.HTMLAttributes<HTMLAsCategoryWidgetElement>;
            "as-category-widget-placeholder": LocalJSX.AsCategoryWidgetPlaceholder & JSXBase.HTMLAttributes<HTMLAsCategoryWidgetPlaceholderElement>;
            "as-dropdown": LocalJSX.AsDropdown & JSXBase.HTMLAttributes<HTMLAsDropdownElement>;
            "as-histogram-widget": LocalJSX.AsHistogramWidget & JSXBase.HTMLAttributes<HTMLAsHistogramWidgetElement>;
            "as-histogram-widget-placeholder": LocalJSX.AsHistogramWidgetPlaceholder & JSXBase.HTMLAttributes<HTMLAsHistogramWidgetPlaceholderElement>;
            "as-infowindow": LocalJSX.AsInfowindow & JSXBase.HTMLAttributes<HTMLAsInfowindowElement>;
            "as-layer-selector": LocalJSX.AsLayerSelector & JSXBase.HTMLAttributes<HTMLAsLayerSelectorElement>;
            "as-layer-selector-slot": LocalJSX.AsLayerSelectorSlot & JSXBase.HTMLAttributes<HTMLAsLayerSelectorSlotElement>;
            "as-legend": LocalJSX.AsLegend & JSXBase.HTMLAttributes<HTMLAsLegendElement>;
            "as-legend-category": LocalJSX.AsLegendCategory & JSXBase.HTMLAttributes<HTMLAsLegendCategoryElement>;
            "as-legend-category-line-entry": LocalJSX.AsLegendCategoryLineEntry & JSXBase.HTMLAttributes<HTMLAsLegendCategoryLineEntryElement>;
            "as-legend-category-point-entry": LocalJSX.AsLegendCategoryPointEntry & JSXBase.HTMLAttributes<HTMLAsLegendCategoryPointEntryElement>;
            "as-legend-category-polygon-entry": LocalJSX.AsLegendCategoryPolygonEntry & JSXBase.HTMLAttributes<HTMLAsLegendCategoryPolygonEntryElement>;
            "as-legend-color-bins": LocalJSX.AsLegendColorBins & JSXBase.HTMLAttributes<HTMLAsLegendColorBinsElement>;
            "as-legend-color-bins-line": LocalJSX.AsLegendColorBinsLine & JSXBase.HTMLAttributes<HTMLAsLegendColorBinsLineElement>;
            "as-legend-color-bins-point": LocalJSX.AsLegendColorBinsPoint & JSXBase.HTMLAttributes<HTMLAsLegendColorBinsPointElement>;
            "as-legend-color-bins-polygon": LocalJSX.AsLegendColorBinsPolygon & JSXBase.HTMLAttributes<HTMLAsLegendColorBinsPolygonElement>;
            "as-legend-color-category": LocalJSX.AsLegendColorCategory & JSXBase.HTMLAttributes<HTMLAsLegendColorCategoryElement>;
            "as-legend-color-category-line": LocalJSX.AsLegendColorCategoryLine & JSXBase.HTMLAttributes<HTMLAsLegendColorCategoryLineElement>;
            "as-legend-color-category-point": LocalJSX.AsLegendColorCategoryPoint & JSXBase.HTMLAttributes<HTMLAsLegendColorCategoryPointElement>;
            "as-legend-color-category-polygon": LocalJSX.AsLegendColorCategoryPolygon & JSXBase.HTMLAttributes<HTMLAsLegendColorCategoryPolygonElement>;
            "as-legend-color-continuous": LocalJSX.AsLegendColorContinuous & JSXBase.HTMLAttributes<HTMLAsLegendColorContinuousElement>;
            "as-legend-color-continuous-line": LocalJSX.AsLegendColorContinuousLine & JSXBase.HTMLAttributes<HTMLAsLegendColorContinuousLineElement>;
            "as-legend-color-continuous-point": LocalJSX.AsLegendColorContinuousPoint & JSXBase.HTMLAttributes<HTMLAsLegendColorContinuousPointElement>;
            "as-legend-color-continuous-polygon": LocalJSX.AsLegendColorContinuousPolygon & JSXBase.HTMLAttributes<HTMLAsLegendColorContinuousPolygonElement>;
            "as-legend-size-bins": LocalJSX.AsLegendSizeBins & JSXBase.HTMLAttributes<HTMLAsLegendSizeBinsElement>;
            "as-legend-size-bins-line": LocalJSX.AsLegendSizeBinsLine & JSXBase.HTMLAttributes<HTMLAsLegendSizeBinsLineElement>;
            "as-legend-size-bins-point": LocalJSX.AsLegendSizeBinsPoint & JSXBase.HTMLAttributes<HTMLAsLegendSizeBinsPointElement>;
            "as-legend-size-category": LocalJSX.AsLegendSizeCategory & JSXBase.HTMLAttributes<HTMLAsLegendSizeCategoryElement>;
            "as-legend-size-category-line": LocalJSX.AsLegendSizeCategoryLine & JSXBase.HTMLAttributes<HTMLAsLegendSizeCategoryLineElement>;
            "as-legend-size-category-point": LocalJSX.AsLegendSizeCategoryPoint & JSXBase.HTMLAttributes<HTMLAsLegendSizeCategoryPointElement>;
            "as-legend-size-continuous": LocalJSX.AsLegendSizeContinuous & JSXBase.HTMLAttributes<HTMLAsLegendSizeContinuousElement>;
            "as-legend-size-continuous-line": LocalJSX.AsLegendSizeContinuousLine & JSXBase.HTMLAttributes<HTMLAsLegendSizeContinuousLineElement>;
            "as-legend-size-continuous-point": LocalJSX.AsLegendSizeContinuousPoint & JSXBase.HTMLAttributes<HTMLAsLegendSizeContinuousPointElement>;
            "as-loader": LocalJSX.AsLoader & JSXBase.HTMLAttributes<HTMLAsLoaderElement>;
            "as-placeholder": LocalJSX.AsPlaceholder & JSXBase.HTMLAttributes<HTMLAsPlaceholderElement>;
            "as-placeholder-bar": LocalJSX.AsPlaceholderBar & JSXBase.HTMLAttributes<HTMLAsPlaceholderBarElement>;
            "as-placeholder-chart": LocalJSX.AsPlaceholderChart & JSXBase.HTMLAttributes<HTMLAsPlaceholderChartElement>;
            "as-placeholder-list": LocalJSX.AsPlaceholderList & JSXBase.HTMLAttributes<HTMLAsPlaceholderListElement>;
            "as-range-slider": LocalJSX.AsRangeSlider & JSXBase.HTMLAttributes<HTMLAsRangeSliderElement>;
            "as-range-slider-bar": LocalJSX.AsRangeSliderBar & JSXBase.HTMLAttributes<HTMLAsRangeSliderBarElement>;
            "as-range-slider-thumb": LocalJSX.AsRangeSliderThumb & JSXBase.HTMLAttributes<HTMLAsRangeSliderThumbElement>;
            "as-responsive-content": LocalJSX.AsResponsiveContent & JSXBase.HTMLAttributes<HTMLAsResponsiveContentElement>;
            "as-stacked-bar-widget": LocalJSX.AsStackedBarWidget & JSXBase.HTMLAttributes<HTMLAsStackedBarWidgetElement>;
            "as-switch": LocalJSX.AsSwitch & JSXBase.HTMLAttributes<HTMLAsSwitchElement>;
            "as-tabs": LocalJSX.AsTabs & JSXBase.HTMLAttributes<HTMLAsTabsElement>;
            "as-time-series-widget": LocalJSX.AsTimeSeriesWidget & JSXBase.HTMLAttributes<HTMLAsTimeSeriesWidgetElement>;
            "as-toolbar": LocalJSX.AsToolbar & JSXBase.HTMLAttributes<HTMLAsToolbarElement>;
            "as-widget-header": LocalJSX.AsWidgetHeader & JSXBase.HTMLAttributes<HTMLAsWidgetHeaderElement>;
            "as-widget-legend": LocalJSX.AsWidgetLegend & JSXBase.HTMLAttributes<HTMLAsWidgetLegendElement>;
            "as-widget-selection": LocalJSX.AsWidgetSelection & JSXBase.HTMLAttributes<HTMLAsWidgetSelectionElement>;
            "as-y-axis": LocalJSX.AsYAxis & JSXBase.HTMLAttributes<HTMLAsYAxisElement>;
        }
    }
}
